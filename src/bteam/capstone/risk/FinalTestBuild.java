...
public class FinalTestBuild {

	private JFrame frmRiskOnlinepre;
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FinalTestBuild window = new FinalTestBuild();
					window.frmRiskOnlinepre.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		...
		final GuiMap2 map = new GuiMap2("NorthAmerica",false,frmRiskOnlinepre.getWidth(), frmRiskOnlinepre.getHeight());
		...
		ORIGIONPANNLE.addMouseListener(new MouseListener(){
		...
		ORIGIONPANNLE.addMouseMotionListener(new MouseMotionListener(){
		...
		ORIGIONPANNLE.setBounds(6, 6, 825, 600);
		frmRiskOnlinepre.getContentPane().add(ORIGIONPANNLE);
		ORIGIONPANNLE.setLayout(null);
		...
		ORIGIONPANNLE.add(ChatContainer);
		...
		ORIGIONPANNLE.add(PlayerPannle);
